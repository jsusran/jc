...
const IndexPage = () => (
    <Layout title="The Legal Agile">
      <div id="home" style={{backgroundColor: "rgb(140, 172, 204)"}} className="h-screen flex z-0 pt-4">
        <div className="w-full flex items-center justify-center lg:w-1/2">
          <img src='/assets/TLALogoBlanco.webp'></img>
        </div>
        <div className="hidden items-center justify-end lg:flex lg:w-1/2">
          <img src='/assets/notebook.webp' className="h-full"></img>
        </div>
      </div>

      <div id="about" style={{backgroundColor: "rgb(36, 52, 84)", boxShadow: "-2px 0px 10px rgba(50, 50, 50, 1)"}} className="min-h-screen flex z-0 flex-col lg:flex-row p-8 pt-6 lg:p-8">
        <div className="min-h-full lg:min-h-screen w-full flex items-center justify-center lg:w-1/2 p-4 pb-12">
          <div>
      ...
      <div id="services" className="bg-white min-h-full lg:h-screen flex z-0 flex-col p-4 pt-6" style={{boxShadow: "-2px 0px 10px rgba(50, 50, 50, 1)"}}>
        ...
        <div className="h-full flex z-0 flex-col lg:flex-row">
          <div className="h-full w-ful flex flex-col items-center justify-center lg:flex lg:w-1/2 p-12">
          ...
          <div className="h-full w-ful flex flex-col items-center justify-center lg:flex lg:w-1/2 p-12">
            <img src='/assets/datacompliance2.webp' className=""></img>
      ...
      <div id="methodology" className="bg-white lg:h-screen flex z-0 flex-col pt-6">
        ...
        <div className="h-full w-full flex z-0 flex-col">
          <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-center" style={{height: "33.33%",}}>
            <div style={{backgroundColor: "rgb(36, 52, 84)", backgroundImage: "url(/assets/img1.jpg)", backgroundSize: "cover", backgroundPosition: "center", minHeight: "10vh"}}
          ...
          <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-center" style={{height: "33.33%"}}>
            <div style={{backgroundColor: "rgb(36, 52, 84)", backgroundImage: "url(/assets/img2.jpg)", backgroundSize: "cover", backgroundPosition: "center", minHeight: "10vh"}}
            className="w-full lg:w-1/2 h-full"></div>
            <div className="w-full lg:w-1/2 p-6">
            <span className="text-xl">
              ESTRATEGIA
          ...
          <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-center" style={{height: "33.34%"}}>
            <div style={{backgroundColor: "rgb(36, 52, 84)", backgroundImage: "url(/assets/img3.jpg)", backgroundSize: "cover", backgroundPosition: "center", minHeight: "10vh"}}
            className="w-full lg:w-1/2 h-full"></div>
            <div className="w-full lg:w-1/2 p-6">
            <span className="text-xl">
      ...
      <div id="contact" className="min-h-screen flex z-0 flex-col pt-6 lg:h-screen" style={{backgroundColor: "rgb(36, 52, 84)", backgroundImage: "url(/assets/keyboard.webp)", boxShadow: "-2px 0px 10px rgba(50, 50, 50, 1)"}}>
        ...
        <div className="h-full flex z-0 flex-col lg:flex-row">
          <div className="h-full w-full flex flex-col items-center justify-center lg:w-1/3">
            <img src='/assets/TLALogoBlanco.webp' className=""></img>
          </div>
          <div className="h-full w-full flex flex-col items-center justify-center lg:w-2/3 p-4">
            <span className="text-white">
            DIRECCIÓN <br/>
